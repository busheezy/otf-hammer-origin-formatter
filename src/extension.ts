...
const originPasteEditKind = vscode.DocumentDropOrPasteEditKind.Text.append("otfHammerOrigin");

const coordinatePattern = String.raw`-?(?:0|[1-9]\d*)(?:\.\d+)?`;

const originPattern = new RegExp(
  String.raw`^\{ origin = "(${coordinatePattern}) ` + String.raw`(${coordinatePattern}) (${coordinatePattern})" \}$`,
);
